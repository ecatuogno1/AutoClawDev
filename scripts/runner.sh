...
MODEL_RESEARCH="${AUTOCLAWDEV_RESEARCH_MODEL:-opus}"
MODEL_PLANNING="${AUTOCLAWDEV_PLANNING_MODEL:-opus}"
MODEL_IMPL="${AUTOCLAWDEV_IMPL_MODEL:-}"          # empty = use Codex (default)
MODEL_REVIEW="${AUTOCLAWDEV_REVIEW_MODEL:-opus}"
MODEL_FIX="${AUTOCLAWDEV_FIX_MODEL:-}"            # empty = codex-spark (default)
CODEX_MODEL="${AUTOCLAWDEV_CODEX_MODEL:-gpt-5.4}" # codex model for Terry/Jerry
